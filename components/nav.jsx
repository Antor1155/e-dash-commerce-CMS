...
const Nav = ({show, setShowNav}) => {
    ...
    return (
        <aside 
            ...
            <Link href={"/"} onClick={()=>setShowNav(false)} className='flex gap-1 mb-4 mr-4'>
            ...
            <nav className='flex flex-col gap-2'>
                ...
                <Link href={"/catagories"} onClick={()=>setShowNav(false)} className={pathname.includes("/catagories") ? activeLink : inactiveLink}>
                ...
                <button onClick={async()=>{await signOut(); setShowNav(false)}}   className={`${inactiveLink} `}>
